 ...
 <div class="container">
  <div class="container brown-text">
    <ul class="collection with-header">
      <li class="collection-header center"><h4>See Players Details...</h4></li>

    <?php foreach($teams as $team) : ?>  
      <li class="collection-item avatar box valign-wrapper">
        <i class="material-icons circle blue">insert_chart</i>
        <div class="title"><a href="clickedteamplayers.php?team_name=<?php echo $team['team_name']; ?>"><?php echo htmlspecialchars($team['team_name']); ?></a></div>
          <div class="container">
            <a class="secondary-content" href="clickedteamplayers.php">
