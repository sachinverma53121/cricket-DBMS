<head>
	<title>Cricket Match DBMS</title>
...
<body>
	<nav class="nav-wrapper blue-grey darken-3 white-text">
		<div class="container">
		<a href="#" class="brand-logo">Cricket-Corporation</a>
		...
		<ul class="right hide-on-med-and-down">
		  ...
		  <li><span class="badge tooltipped white-text pink new" data-tooltip="5 new notifications available">5</span></li>
		</ul> 
		</div>
	</nav>
